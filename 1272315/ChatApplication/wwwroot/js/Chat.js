...
const connection = new signalR.HubConnectionBuilder().withUrl("http://localhost:5400/chatHub").configureLogging(signalR.LogLevel.Information).build();
...
const appendFile = (user, fileName, fileData, messageClass) => {
    ...
    if (fileName.match(/\.(jpg|jpeg|png|gif)$/)) { 
        ...
        fileText.textContent = `File type not supported to Preview. You can Download to Preview it.`;
